...
public class InscripcionManager {
    ...
    private static final String SQL_INSERT = "INSERT INTO inscripcion (idcursohabilitado, idalumno) VALUES (?,?)";
    private static final String SQL = "SELECT * FROM inscripcion";
    private static final String SQL_DELETE = "DELETE FROM inscripcion WHERE idinscripcion=?";
    private static final String SQL_MODIFY = "UPDATE inscripcion SET idcursohabilitado=?, idalumno=? WHERE idinscripcion=?";
